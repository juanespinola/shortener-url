                    ...
                    <button type="button" class="flex items-center gap-2.5" @click="toggle()">
                        <div class="text-start">
                            <div class="flex items-center gap-1">
                                <span class="hidden xl:block text-sm text-lightgray">Resources</span>
                                <svg width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-lightgray">
                    ...
                    <ul x-show="open" x-transition="" x-transition.duration.300ms="" style="display: none;">
                        <li>
                            <a href="{{ route('information', ['locale' => app()->getLocale()]) }}" class="flex items-center gap-2.5 text-lightgray hover:text-primary duration-300 text-sm font-semibold">
                                ...
                                <span class="lg:block hidden">Información</span>
                            </a>
                        </li>
                        <li>
