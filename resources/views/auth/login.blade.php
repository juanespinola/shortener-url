...
{{--                    <img src="{{ asset('assets/images/logo-dark.svg') }}" class="dark-logo h-8 logo dark:hidden"--}}
{{--                        alt="logo" />--}}
{{--                    <img src="{{ asset('assets/images/logo-light.svg') }}" class="light-logo h-8 logo hidden dark:block"--}}
{{--                        alt="logo" />--}}
{{--                </a>--}}
                <div></div>
            ...
            <div class="min-h-[calc(100vh-192px)] p-7 flex justify-center items-center">
                <div
                    ...
                    <form class="mt-[60px] space-y-5" method="POST" action="{{ route('login') }}">
                        @csrf
                        <div class="relative">
                        ...
                        <div class="flex items-center gap-2 justify-between flex-wrap">
                            ...
                            @if (Route::has('password.request'))
                                <span>
                                    <a href="{{ route('password.request') }}" class="hover:text-primary duration-300">Forgot
                                        Password?</a>
                                </span>
                            @endif
                        </div>
