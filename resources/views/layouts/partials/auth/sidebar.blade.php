...
{{--        <div class="p-3.5 flex text-center">--}}
{{--            <a href="{{ route('home', ['locale' => app()->getLocale()]) }}" class="w-full font-bold">--}}
{{--                <span class="h-8 mx-auto text-xl pl-1.5">JustAnotherLinkCut</span>--}}
{{--            </a>--}}
{{--        </div>--}}
        <div></div>
